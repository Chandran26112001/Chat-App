...
import com.example.myapplication.Fragments.SummaFragment;
...
public class StartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPagerAdapter.addFragment(new SummaFragment(),"Summa !");
        viewPagerAdapter.addFragment(new ProfileFragment(),"Ur Profile !");
